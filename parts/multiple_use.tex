...
\begin{figure}
        ...
        \begin{tikzpicture}[node distance=0.5cm]
            ...
            \node[calc, left = of Pi] (i) { \footnotesize
                \begin{tabular}{c}
                    $h \leftarrow \sum_{k \in \{i,j,s\}} h_k \prod_{\ell \neq k} \frac{- \alpha_\ell}{\alpha_k - \alpha_\ell}$ \\
                    $A \leftarrow a^{\frac{1}{h}}$ \\
                    $G_i \leftarrow g_{ii} + g_{ji}$
                \end{tabular}
            };
            
            \node[calc, right = of Pj] (j) { \footnotesize
                \begin{tabular}{c}
                    $G_j \leftarrow g_{ij} + g_{jj}$
                \end{tabular}
            };
            
            \draw[edge] (Pi) to node[sloped,midway,above] {$A$} (Pj);
...
\begin{figure}
        ...
        \begin{tikzpicture}[node distance=0.5cm]
            ...
            \node[calc, left = of Pi] (i) { \footnotesize
                \begin{tabular}{c}
                    $A_i \leftarrow A^{G_i}$ \\
                    Output $\leftarrow A_i^{\frac{-x_j}{x_i-x_j}} A_j^{\frac{-x_i}{x_j-x_i}}$
                \end{tabular}
            };
            ...
            \draw[edge] (Pj) to node[sloped,midway,above] {$A_j$} (Pi);
