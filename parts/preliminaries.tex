...
Oblivious polynomial evaluation is a protocol involving two parties, a sender whose input is a polynomial $P$, and a receiver whose input is a value $\alpha$. Ath the end of the protocol, the receiver learns $P(\alpha)$ and the sender learns nothing.
